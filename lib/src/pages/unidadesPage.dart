...
body(context){
  return SingleChildScrollView(
    child: Column(
      ...
      children: [
        Padding(padding: EdgeInsets.fromLTRB(16, 16, 0, 4), child: Text("Selecione a unidade mais próxima a você"),),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                IconButton(
                                    onPressed: () => {
                                         Navigator.push(
                                            context, MaterialPageRoute(builder: (context) => medicosPage()))
                                    },
                                    icon: Icon(

  ...
  body(context) {
    return  FutureBuilder<List<Medico>>(
             ...
             print(medicosPage.unidade?.codigo);
                  ...
                  return Center(
                      child: Text('Não foi possível carregar os médicos'));
                } else {
            ...
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: Text(medico.sexo == 'M'? 
                    "Dr. ${medico.nome} ${medico.sobrenome}" :"Dra. ${medico.nome} ${medico.sobrenome}",
              ...
              child: Row(
                ...
                children: [
                  ...
                  Card(
                    ...
                    color: medico.especialidade == 'Clínico Geral'? Color(0xff00d59e): Color.fromARGB(255, 0, 122, 198),
